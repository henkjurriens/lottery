...
["game_loop_html", "package:game_loop/game_loop_html.dart", , G, {
  ...
  GameLoopHtml: {
    ...
    _processMouseEvents$0: function() {
      var t1, docElem, box, t2, t3, t4, t5, canvasX, canvasY, mouseEvent, t6, time, mouseX, x, y, clampX, withinCanvas, t7, t8, t9, clampY, dx, dy, buttonId;
      t1 = this._mouse;
      t1._wheelDx = 0;
      t1._wheelDy = 0;
      t1._dx = 0;
  ...
  PointerLock: {
    ...
    }, "call$1", "get$_onClick", 2, 0, 20],
    _onPointerLockChange$1: [function($event) {
    }, "call$1", "get$_onPointerLockChange", 2, 0, 20],
    PointerLock$1: function(gameLoop) {
      var t1 = C.EventStreamProvider_click.forElement$1(this.gameLoop.element);
...
["", "random.dart", , A, {
  "": "",
  Participants__parseParticipantsFromJSON: [function(jsonString) {
    $.Participants_names = J.$index$asx(C.C_JsonCodec.decode$1(jsonString), "names");
  }, "call$1", "Participants__parseParticipantsFromJSON$closure", 2, 0, 9],
  main: [function() {
    var e, t1, button, t2, t3, timer;
    ...
    if (!t1._initialized) {
      ...
      t2 = C.EventStreamProvider_touchstart.forElement$1(e);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$_touchStartEvent()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_touchend.forElement$1(e);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$_touchEndEvent()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_touchcancel.forElement$1(e);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$_touchEndEvent()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_touchmove.forElement$1(e);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$_touchMoveEvent()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_keydown.forTarget$1(window);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$_keyDown()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_keyup.forTarget$1(window);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$_keyUp()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_resize.forTarget$1(window);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$_resize()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_mousemove.forElement$1(e);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$_mouseMove()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_mousedown.forElement$1(e);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$_mouseDown()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_mouseup.forElement$1(e);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$_mouseUp()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C._CustomEventStreamProvider__determineMouseWheelEventType.forElement$1(e);
    ...
    t3 = $.gameLoop;
    t3.toString;
    timer = new B.GameLoopTimer(t3, new A.main_closure0(), 0, 0.3, true);
    timer._timeToFireRemaining = 0.3;
    t3._timers.push(timer);
    t3 = W.HttpRequest_getString("participants.json", null, null).then$1(A.Participants__parseParticipantsFromJSON$closure()).then$1(new A.main_closure1());
    t2 = $.Zone__current;
    t1 = P._registerErrorHandler(new A.main_closure2(), t2);
    t2.toString;
    t3._addListener$1(H.setRuntimeTypeInfo(new P._Future(0, t2, null, null, null, null, t1, null), [null]));
  ...
  main_closure0: {
    ...
    call$1: function(timer) {
      ...
      if ($.started) {
        ...
        t1 = false;
      if (t1) {
        $.randomNumber = C.C__JSRandom.nextInt$1(109) + 1;
        t1 = $.ctx;
        t1.fillStyle = "rgb(0,167,255)";
        t1.fillRect(10, 10, $.width, $.height);
        t1 = $.ctx;
        t1.strokeStyle = "black";
        t1.font = "150px Arial";
        t1.fillStyle = "white";
        t2 = J.$index$asx($.get$Participants_names(), $.randomNumber - 1);
        t3 = $.height;
        t1.toString;
        t1.fillText(t2, 50, t3 - 50);
        t1 = $.count;
        if (typeof t1 !== "number")
          return t1.$add();
        $.count = t1 + 1;
  ...
  main_closure2: {
    ...
    call$1: function(arrr) {
      P.print("Error initializing participants: " + H.S(arrr));
    }
  }
},
1],
...
Isolate.$lazy($, "names", "Participants_names", "get$Participants_names", function() {
  return [];
});
// Native classes
...
function dart_precompiled($collectedClasses) {
  ...
  function GameLoopTimer(gameLoop, onTimer, _timeToFireRemaining, _timeToFire, periodic) {
    this.gameLoop = gameLoop;
    this.onTimer = onTimer;
    this._timeToFireRemaining = _timeToFireRemaining;
    this._timeToFire = _timeToFire;
